...
非常抱歉打扰您😭我是小明，😭😭😭我在计算I = \iiint\limits_{x^2+y^2+z^2 \le R^2} \left【 \int_{0}^{\sqrt{R^2 - x^2 - y^2 - z^2}} e^{-(x^2+y^2+z^2+t^2)} \, dt \right】 \, dV时，😭😭错算成了\boxed{\pi^2 \left【 1 - (R^2+1)e^{-R^2} \right】}，你能帮我算出正确答案吗？😭😭😭🙏🙏🙏🙏
#### 实例化对象
